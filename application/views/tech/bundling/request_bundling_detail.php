        ...
        <div class="col-md-12">
          <div class="card card-info shadow">
            ...
            <div class="card-body">
                ...
                <?php if ($request_bundling['status'] == 'finish' || $request_bundling['status'] == 'success') { ?>
                  <div class="col-md-6 pt-0 mt-0">
                    <div class="form-group">
                      ...
                      <p class="mb-0 pb-0">
                        <img src="<?= base_url('assets/img/photo/' . $request_bundling['photo']) ?>" alt="" width="2  00px">
                      </p>
                      <hr class="mt-0 pt-0">
                    </div>
                  </div>
              ...
              <?php if (!empty($this->uri->segment(6))) { ?>
                <a href="<?= base_url('tech/bundling/request_bundling/' . $this->uri->segment(4) . '/' . $this->uri->segment(5)); ?>" class="btn btn-info float-right">Back</a>
              <?php } elseif (empty($this->uri->segment(6)) and !empty($this->uri->segment(5))) { ?>
                <a href="<?= base_url('tech/bundling/request_bundling/' . $this->uri->segment(4)); ?>" class="btn btn-info float-right">Back</a>
              <?php } else { ?>
                <a href="<?= base_url('tech/bundling/request_bundling'); ?>" class="btn btn-info float-right">Back</a>
              <?php } ?>
            </div>
          </div>
        </div>
