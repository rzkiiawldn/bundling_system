      ...
      <div class="row mb-2">
        <div class="col-sm-6">
          <?php if (!empty($this->uri->segment(5))) { ?>
            <a href="<?= base_url('tech/bundling/rb_create/' . $this->uri->segment(4) . '/' . $this->uri->segment(5)); ?>" class="btn btn-info text-light"> <i class="fas fa-undo-alt"></i> CREATE</a>
          <?php } elseif (empty($this->uri->segment(5)) and !empty($this->uri->segment(4))) { ?>
            <a href="<?= base_url('tech/bundling/rb_create/' . $this->uri->segment(4)); ?>" class="btn btn-info text-light"> <i class="fas fa-undo-alt"></i> CREATE</a>
          <?php } else { ?>
            <a href="<?= base_url('tech/bundling/rb_create'); ?>" class="btn btn-info text-light"> <i class="fas fa-undo-alt"></i> CREATE</a>
          <?php } ?>
        </div>
        <div class="col-sm-6">
