              ...
              <?php if (!empty($this->uri->segment(5))) { ?>
                ...
                <?php } elseif (empty($this->uri->segment(5)) and !empty($this->uri->segment(4))) { ?>
                  ...
                  <?php } else { ?>
                            ...
                            <tr>
                              ...
                              <td>
                                <?php if (!empty($this->uri->segment(6))) { ?>
                                  <form action="<?= base_url('tech/bundling/delete_item_satuann/' . $this->uri->segment(4) . '/' . $this->uri->segment(5) . '/' . $row['id_item_bundling_detail']); ?>" method="post">
                                ...
                                <?php } elseif (empty($this->uri->segment(6)) and !empty($this->uri->segment(5))) { ?>
                                  <form action="<?= base_url('tech/bundling/delete_item_satuann/' . $this->uri->segment(4) . '/' . $row['id_item_bundling_detail']); ?>" method="post">
                                    <input type="hidden" name="id_item_bundling_detail" value="<?= $row['id_item_bundling_detail'] ?>">
                                    <input type="hidden" name="id_item_bundling" value="<?= $row['id_item_bundling'] ?>">
                                    <input type="hidden" name="item_qty" value="<?= $row['item_qty'] ?>">
                                    <input type="hidden" name="price" value="<?= $row['price'] ?>">
                                ...
                                <?php } else { ?>
                                  <form action="<?= base_url('tech/bundling/delete_item_satuann/' . $row['id_item_bundling_detail']); ?>" method="post">
                                    <input type="hidden" name="id_item_bundling_detail" value="<?= $row['id_item_bundling_detail'] ?>">
                                    <input type="hidden" name="id_item_bundling" value="<?= $row['id_item_bundling'] ?>">
                                    <input type="hidden" name="item_qty" value="<?= $row['item_qty'] ?>">
                                    <input type="hidden" name="price" value="<?= $row['price'] ?>">
                    ...
                    <?php if (!empty($this->uri->segment(6))) { ?>
                      <a href="<?= base_url('tech/bundling/item_bundling/' . $this->uri->segment(4) . '/' . $this->uri->segment(5)); ?>" class="btn btn-danger float-right mt-3">Finish</a>
                    <?php } elseif (empty($this->uri->segment(6)) and !empty($this->uri->segment(5))) { ?>
                      <a href="<?= base_url('tech/bundling/item_bundling/' . $this->uri->segment(4)); ?>" class="btn btn-danger float-right mt-3">Finish</a>
                    <?php } else { ?>
                      <a href="<?= base_url('tech/bundling/item_bundling') ?>" class="btn btn-danger float-right mt-3">Finish</a>
                    <?php } ?>
            </div>
          </div>
        </div>
