        ...
        <div class="col-md-12">
          <div class="card card-info shadow">
            ...
            <div class="card-body">
              ...
              <?php if (!empty($this->uri->segment(6))) { ?>
                <a href="<?= base_url('tech/master_data/item/' . $this->uri->segment(4) . '/' . $this->uri->segment(5)); ?>" class="btn btn-info float-right">Back</a>
              <?php } elseif (empty($this->uri->segment(6)) and !empty($this->uri->segment(5))) { ?>
                <a href="<?= base_url('tech/master_data/item/' . $this->uri->segment(4)); ?>" class="btn btn-info float-right">Back</a>
              <?php } else { ?>
                <a href="<?= base_url('tech/master_data/item/'); ?>" class="btn btn-info float-right">Back</a>
              <?php } ?>
            </div>
          </div>
        </div>
