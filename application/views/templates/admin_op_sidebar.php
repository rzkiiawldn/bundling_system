      ...
      <ul class="nav nav-pills nav-sidebar flex-column text-uppercase" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <select class="form-control select2bs4" onchange="location = this.options[this.selectedIndex].value;">
            ...
            <?php foreach ($client as $row) : ?>
              <?php if ($row['id_client'] == $this->uri->segment(4)) { ?>
                <option value="<?= base_url('admin_op/dashboard/index/' . $row['id_client']) ?>" selected><?= $row['client_name']; ?></option>
              <?php } else { ?>
                <option value="<?= base_url('admin_op/dashboard/index/' . $row['id_client']) ?>"><?= $row['client_name']; ?></option>
              <?php } ?>
            <?php endforeach; ?>
          </select>
        </div>
        ...
        <?php if (!empty($this->uri->segment(4))) { ?>
          ...
          <li class="nav-item <?= $this->uri->segment(2) == 'dashboard' ? 'menu-open' : null; ?>">
            <a href="<?= base_url('admin_op/dashboard/index/' . $id); ?>" class="nav-link">
          ...
          <li class="nav-item <?= $this->uri->segment(2) == 'master_data' ? 'menu-open' : null; ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url('admin_op/master_data/item/' . $id); ?>" class="nav-link">
          ...
          <li class="nav-item <?= $this->uri->segment(2) == 'bundling' ? 'menu-open' : null; ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url('admin_op/bundling/item_bundling/' . $id); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Item Bundling</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url('admin_op/bundling/request_bundling/' . $id); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item <?= $this->uri->segment(2) == 'reports' ? 'menu-open' : null; ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url('admin_op/reports/report_request_bundling/' . $id); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Request Bundling</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url('admin_op/reports/news_bundling_report/' . $id); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
        ...
        <?php } else { ?>
          <!-- ADMIN OPERATION -->
          <li class="nav-item <?= $this->uri->segment(2) == 'dashboard' ? 'menu-open' : null; ?>">
            <a href="<?= base_url('admin_op/dashboard'); ?>" class="nav-link">
              <i class="nav-icon  fas fa-tachometer-alt"></i>
              <p>
                Dashboard
              </p>
          ...
          <li class="nav-item <?= $this->uri->segment(2) == 'master_data' ? 'menu-open' : null; ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url('admin_op/master_data/item'); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Item</p>
                </a>
              </li>
          ...
          <li class="nav-item <?= $this->uri->segment(2) == 'bundling' ? 'menu-open' : null; ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url('admin_op/bundling/item_bundling'); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Item Bundling</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url('admin_op/bundling/request_bundling'); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Request Bundling</p>
                </a>
              </li>
          ...
          <li class="nav-item <?= $this->uri->segment(2) == 'reports' ? 'menu-open' : null; ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url('admin_op/reports/report_request_bundling'); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Request Bundling</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url('admin_op/reports/news_bundling_report'); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>News Bundling Report</p>
                </a>
              </li>
