      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-info shadow">
            ...
            <?php if (!empty($this->uri->segment(5))) { ?>
              <form action="<?= base_url('admin_op/reports/add_edit_item/' . $this->uri->segment(4)); ?>" method="post">
              <?php } else { ?>
                <form method="post" action="<?= base_url('admin_op/reports/add_edit_item') ?>">
                <?php } ?>
                <div class="row mt-4">
                    ...
                    <tbody>
                      ...
                      foreach ($news_detail as $row) : ?>
                        <tr>
                          ...
                          <td>
                            <?php if (!empty($this->uri->segment(5))) { ?>
                              <form action="<?= base_url('admin_op/reports/delete_item_satuan/' . $this->uri->segment(4) . '/' . $row['id_news_detail']); ?>" method="post">
                            ...
                            <?php } else { ?>
                              <form action="<?= base_url('admin_op/reports/delete_item_satuan/' . $row['id_news_detail']); ?>" method="post">
                                <input type="hidden" name="id_news_detail" value="<?= $row['id_news_detail'] ?>">
                                <input type="hidden" name="id_news" value="<?= $row['id_news'] ?>">
                                <button type="submit" class="btn btn-sm btn-danger" title="hapus" onclick="return confirm('Delete ?')"><i class="fas fa-trash"></i></button>
                              </form>
                ...
                <?php if (!empty($this->uri->segment(5))) { ?>
                  <a href="<?= base_url('admin_op/reports/news_bundling_report/' . $this->uri->segment(4)); ?>" class="btn btn-danger float-right mt-3">Finish</a>
                <?php } else { ?>
                  <a href="<?= base_url('admin_op/reports/news_bundling_report') ?>" class="btn btn-danger float-right mt-3">Finish</a>
                <?php } ?>
          </div>
        </div>
      </div>
