                ...
                <tbody>
                  ...
                  foreach ($item_nonbundling as $row) : ?>
                    <tr>
                      ...
                      <td>
                        <?php if (!empty($this->uri->segment(4))) { ?>
                          <a href="<?= base_url('admin_op/master_data/detail_item/' . $this->uri->segment(4) . '/' . $row['id_item_nonbundling']); ?>" class="btn btn-sm btn-info" title="detail"><i class="fas fa-eye"></i></a>
                        <?php } else { ?>
                          <a href="<?= base_url('admin_op/master_data/detail/' . $row['id_item_nonbundling']); ?>" class="btn btn-sm btn-info" title="detail"><i class="fas fa-eye"></i></a>
                        <?php } ?>
                      </td>
                    </tr>
                  <?php endforeach; ?>
