        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <?php if (!empty($this->uri->segment(5))) { ?>
              ...
              <li class="breadcrumb-item"><a href="<?= base_url('admin_op/bundling/item_bundling/' . $this->uri->segment(4)); ?>">Item</a></li>
            <?php } else { ?>
              <li class="breadcrumb-item"><a href="<?= base_url('admin_op/dashboard'); ?>">Home</a></li>
              <li class="breadcrumb-item"><a href="<?= base_url('admin_op/bundling/item_bundling'); ?>">Item</a></li>
            <?php } ?>
            ...
            <div class="card-body">
              ...
              <div class="row mt-3">
                <div class="col-md-12">
                  ...
                  <?php if (!empty($this->uri->segment(5))) { ?>
                    <a href="<?= base_url('admin_op/bundling/item_bundling/' . $this->uri->segment(4)); ?>" class="btn btn-info float-right">Back</a>
                  <?php } else { ?>
                    <a href="<?= base_url('admin_op/bundling/item_bundling') ?>" class="btn btn-info float-right">Back</a>
                  <?php } ?>
                </div>
              </div>
            </div>
