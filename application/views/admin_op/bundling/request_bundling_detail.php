      ...
      <div class="row mb-2">
        <div class="col-sm-6">
          <?php if (!empty($this->uri->segment(5))) { ?>
            <a href="<?= base_url('admin_op/bundling/request_bundling/' . $this->uri->segment(4)); ?>" class="btn btn-info text-light"> <i class="fas fa-undo-alt"></i> BACK</a>
          <?php } else { ?>
            <a href="<?= base_url('admin_op/bundling/request_bundling'); ?>" class="btn btn-info text-light"> <i class="fas fa-undo-alt"></i> BACK</a>
          <?php } ?>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <?php if (!empty($this->uri->segment(5))) { ?>
              ...
              <li class="breadcrumb-item"><a href="<?= base_url('admin_op/bundling/request_bundling/' . $this->uri->segment(4)); ?>">Item</a></li>
            <?php } else { ?>
              <li class="breadcrumb-item"><a href="<?= base_url('admin_op/dashboard'); ?>">Home</a></li>
              <li class="breadcrumb-item"><a href="<?= base_url('admin_op/bundling/request_bundling'); ?>">Item</a></li>
            <?php } ?>
        ...
        <div class="col-md-12">
          <div class="card card-info shadow">
            ...
            <div class="card-body">
              ...
              <?php } else { ?>
                <a href="<?= base_url('admin_op/bundling/request_bundling'); ?>" class="btn btn-info float-right">Back</a>
              <?php } ?>
            </div>
          </div>
        </div>
