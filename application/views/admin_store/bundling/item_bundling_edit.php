      ...
      <div class="row mb-2">
        <div class="col-sm-6">
          <?php if (!empty($this->uri->segment(6))) { ?>
            <a href="<?= base_url('admin_store/bundling/' . $this->uri->segment(4) . '/' . $this->uri->segment(5)); ?>" class="btn btn-info text-light"> <i class="far fa-sticky-note mr-2"></i> BACK</a>
          <?php } elseif (empty($this->uri->segment(6)) and !empty($this->uri->segment(5))) { ?>
            <a href="<?= base_url('admin_store/bundling/' . $this->uri->segment(4)); ?>" class="btn btn-info text-light"> <i class="far fa-sticky-note mr-2"></i> BACK</a>
          <?php } else { ?>
        ...
        <div class="col-md-12">
          <div class="card card-info shadow">
            ...
            <div class="card-body">
              ...
              <?php if (!empty($this->uri->segment(6))) { ?>
                <form action="<?= base_url('admin_store/bundling/add_edit_item/' . $this->uri->segment(4) . '/' . $this->uri->segment(5)); ?>" method="post">
                <?php } elseif (empty($this->uri->segment(6)) and !empty($this->uri->segment(5))) { ?>
                  <form action="<?= base_url('admin_store/bundling/add_edit_item/' . $this->uri->segment(4)); ?>" method="post">
                  <?php } else { ?>
                    <form method="post" action="<?= base_url('admin_store/bundling/add_edit_item') ?>">
                    <?php } ?>
                    <div class="row mt-4">
                      <div class="form-group col-md-6">
                        ...
                        <tbody>
                          ...
                          foreach ($item_bundling_detail as $row) : ?>
                            <tr>
                              ...
                              <td>
                                <?php if (!empty($this->uri->segment(6))) { ?>
                                  <form action="<?= base_url('admin_store/bundling/delete_item_satuan/' . $this->uri->segment(4) . '/' . $this->uri->segment(5) . '/' . $row['id_item_bundling_detail']); ?>" method="post">
                                ...
                                <?php } elseif (empty($this->uri->segment(6)) and !empty($this->uri->segment(5))) { ?>
                                  <form action="<?= base_url('admin_store/bundling/delete_item_satuan/' . $this->uri->segment(4) . '/' . $row['id_item_bundling_detail']); ?>" method="post">
                                    <input type="hidden" name="id_item_bundling_detail" value="<?= $row['id_item_bundling_detail'] ?>">
                                    <input type="hidden" name="id_item_bundling" value="<?= $row['id_item_bundling'] ?>">
                                    <input type="hidden" name="item_qty" value="<?= $row['item_qty'] ?>">
                                    <input type="hidden" name="price" value="<?= $row['price'] ?>">
                                ...
                                <?php } else { ?>
                                  <form action="<?= base_url('admin_store/bundling/delete_item_satuan/' . $row['id_item_bundling_detail']); ?>" method="post">
                                    <input type="hidden" name="id_item_bundling_detail" value="<?= $row['id_item_bundling_detail'] ?>">
                                    <input type="hidden" name="id_item_bundling" value="<?= $row['id_item_bundling'] ?>">
                                    <input type="hidden" name="item_qty" value="<?= $row['item_qty'] ?>">
                                    <input type="hidden" name="price" value="<?= $row['price'] ?>">
