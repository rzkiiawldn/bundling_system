            ...
            <div class="card-body">
              ...
              <div class="row mt-3">
                <div class="col-md-12">
                  ...
                  <?php if (!empty($this->uri->segment(6))) { ?>
                    <a href="<?= base_url('admin_store/bundling/item_bundling/' . $this->uri->segment(4) . '/' . $this->uri->segment(5)); ?>" class="btn btn-info float-right">Back</a>
                  <?php } elseif (empty($this->uri->segment(6)) and !empty($this->uri->segment(5))) { ?>
                    <a href="<?= base_url('admin_store/bundling/item_bundling/' . $this->uri->segment(4)); ?>" class="btn btn-info float-right">Back</a>
                  <?php } else { ?>
                    <a href="<?= base_url('admin_store/bundling/item_bundling') ?>" class="btn btn-info float-right">Back</a>
                  <?php } ?>
                </div>
              </div>
            </div>
