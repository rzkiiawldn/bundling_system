<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <a href="<?= base_url('client/master_data/item'); ?>" class="btn btn-info text-light"> <i class="far fa-sticky-note mr-2"></i> BACK</a>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?= base_url('client/dashboard'); ?>">Home</a></li>
            <li class="breadcrumb-item"><a href="<?= base_url('client/master_data/item'); ?>">Item</a></li>
        ...
        <div class="col-md-12">
          <div class="card card-info shadow">
            ...
            <div class="card-body">
              ...
              <a href="<?= base_url('client/master_data/item'); ?>" class="btn btn-info float-right">Back</a>
            </div>
          </div>
        </div>
      </div>
