                ...
                <tbody>
                  ...
                  foreach ($request_bundling as $row) : ?>
                    <tr>
                      ...
                      <td>
                        <?php if (!empty($this->uri->segment(4))) { ?>
                          <a href="<?= base_url('spv/bundling/rb_detaill/' . $this->uri->segment(4) . '/' . $row['id_request_bundling']); ?>" class="btn btn-sm btn-info" title="detail"><i class="fas fa-eye"></i></a>
                        <?php } else { ?>
                          <a href="<?= base_url('spv/bundling/rb_detail/' . $row['id_request_bundling']); ?>" class="btn btn-sm btn-info" title="detail"><i class="fas fa-eye"></i></a>
                        <?php } ?>
                      </td>
                    </tr>
                  <?php endforeach; ?>
  ...
  <div class="modal fade" id="uploadBukti<?= $row['id_request_bundling'] ?>" tabindex="-1" role="dialog" aria-labelledby="uploadBuktiLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="<?= base_url('spv/bundling/upload_photo/' . $row['id_request_bundling']) ?>" method="post" enctype="multipart/form-data">
