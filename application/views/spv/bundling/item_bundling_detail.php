      ...
      <div class="row mb-2">
        <div class="col-sm-6">
          <?php if (!empty($this->uri->segment(5))) { ?>
            <a href="<?= base_url('spv/bundling/item_bundling/' . $this->uri->segment(4)); ?>" class="btn btn-info text-light"> <i class="far fa-sticky-note mr-2"></i> BACK</a>
          <?php } else { ?>
            <a href="<?= base_url('spv/bundling/item_bundling'); ?>" class="btn btn-info text-light"> <i class="far fa-sticky-note mr-2"></i> BACK</a>
          <?php } ?>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <?php if (!empty($this->uri->segment(5))) { ?>
              ...
              <li class="breadcrumb-item"><a href="<?= base_url('spv/bundling/item_bundling/' . $this->uri->segment(4)); ?>">Item</a></li>
            <?php } else { ?>
              <li class="breadcrumb-item"><a href="<?= base_url('spv/dashboard'); ?>">Home</a></li>
              <li class="breadcrumb-item"><a href="<?= base_url('spv/bundling/item_bundling'); ?>">Item</a></li>
            <?php } ?>
            ...
            <div class="card-body">
              <div class="row text-uppercase" style="font-size: 14px;">
                ...
                <div class="col-md-6 pt-0 mt-0">
                  <div class="form-group">
                    ...
                    <p class="mb-0 pb-0"><?= $item_bundling['manage_by']; ?></p>
                    <hr class="mt-0 pt-0">
                  </div>
                </div>
                <div class="col-md-6 pt-0 mt-0">
              ...
              <div class="row mt-3">
                <div class="col-md-12">
                  ...
                  <?php if (!empty($this->uri->segment(5))) { ?>
                    <a href="<?= base_url('spv/bundling/item_bundling/' . $this->uri->segment(4)); ?>" class="btn btn-info float-right">Back</a>
                  <?php } else { ?>
                    <a href="<?= base_url('spv/bundling/item_bundling') ?>" class="btn btn-info float-right">Back</a>
                  <?php } ?>
                </div>
              </div>
            </div>
