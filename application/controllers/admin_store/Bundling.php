...
class Bundling extends CI_Controller
{
  ...
  public function item_bundling($id_location = null, $id_client = null)
  {
    ...
    $this->load->view('admin_store/bundling/item_bundling');
  ...
  public function ib_detail($id_item_bundling)
  {
    ...
    $this->load->view('templates/admin_store_sidebar');
    $this->load->view('templates/navbar');
    $this->load->view('admin_store/bundling/item_bundling_detail');
    $this->load->view('templates/footer');
  }
  ...
  public function ib_create($id_location = null, $id_client = null)
  {
    ...
    if ($this->form_validation->run() == false) {
      ...
      $this->load->view('templates/admin_store_sidebar');
      $this->load->view('templates/navbar');
      $this->load->view('admin_store/bundling/item_bundling_create');
      $this->load->view('templates/footer');
    } else {
      $data = [
      ...
      if (!empty($this->uri->segment(5))) {
        ...
        redirect('admin_store/bundling/detail_information/' . $this->uri->segment(4) . '/' . $this->uri->segment(5) . '/' . $id_item_bundling);
      } elseif (empty($this->uri->segment(5)) and !empty($this->uri->segment(4))) {
        $id_item_bundling = $this->db->insert_id();
        redirect('admin_store/bundling/detail_informationnn/' . $this->uri->segment(4) . '/' . $id_item_bundling);
      } else {
        $id_item_bundling = $this->db->insert_id();
        redirect('admin_store/bundling/detail_informationn/' . $id_item_bundling);
      }
    }
  }
  ...
  public function detail_informationn($id_item_bundling)
  {
    ...
    $this->load->view('templates/admin_store_sidebar');
    $this->load->view('templates/navbar');
    $this->load->view('admin_store/bundling/item_bundling_detail_information');
    $this->load->view('templates/footer');
  }
  ...
  public function add_edit_item($id_location = null, $id_client = null)
  {
    ...
    if ($cek->num_rows() > 0) {
      ...
      $this->session->set_flashdata('pesan', '<div class="alert alert-danger" role="alert">item tidak boleh sama, silahkan pilih item lainnya</div>');
      if (!empty($this->uri->segment(5))) {
        redirect('admin_store/bundling/ib_edittt/' . $this->uri->segment(4) . '/' . $this->uri->segment(5) . '/' . $id_item_bundling);
      } elseif (empty($this->uri->segment(5)) and !empty($this->uri->segment(4))) {
        redirect('admin_store/bundling/ib_editt/' . $this->uri->segment(4) . '/' . $id_item_bundling);
      } else {
        redirect('admin_store/bundling/ib_edit/' . $id_item_bundling);
      }
    } else {
  ...
  public function ib_edit($id_item_bundling)
  {
    ...
    if ($this->form_validation->run() == false) {
      ...
      $this->load->view('templates/admin_store_sidebar');
      $this->load->view('templates/navbar');
      $this->load->view('admin_store/bundling/item_bundling_edit');
      $this->load->view('templates/footer');
    } else {
  ...
  public function ib_delete($id_item_bundling)
  {
    ...
    redirect('admin_store/bundling/item_bundling');
  }
  ...
  public function ib_deletee($id_location = null, $id_item_bundling)
  {
    ...
    redirect('admin_store/bundling/item_bundling/' . $this->uri->segment(4));
  }
  ...
  public function ib_deleteee($id_location = null, $id_client = null, $id_item_bundling)
  {
    ...
    $this->db->delete('item_bundling_detail');
    $this->session->set_flashdata('pesan', '<div class="alert alert-success" role="alert">Data User Berhasil Dihapus</div>');
    redirect('admin_store/bundling/item_bundling/' . $this->uri->segment(4) . '/' . $this->uri->segment(5));
  }
  ...
  public function request_bundling($id_location = null, $id_client = null)
  {
    ...
    $this->load->view('templates/admin_store_sidebar');
    $this->load->view('templates/navbar');
    $this->load->view('admin_store/bundling/request_bundling');
    $this->load->view('templates/footer');
  }
  ...
  public function rb_detail($id_request_bundling)
  {
    ...
    $this->load->view('templates/admin_store_sidebar');
    $this->load->view('templates/navbar');
    $this->load->view('admin_store/bundling/request_bundling_detail');
    $this->load->view('templates/footer');
  }
  ...
  public function rb_create($id_location = null, $id_client = null)
  {
    ...
    if ($this->form_validation->run() == false) {
      ...
      $this->load->view('templates/admin_store_sidebar');
      $this->load->view('templates/navbar');
      $this->load->view('admin_store/bundling/request_bundling_create');
      $this->load->view('templates/footer');
    } else {
      $data = [
      ...
      if (!empty($this->uri->segment(5))) {
        redirect('admin_store/bundling/request_bundling/' . $this->uri->segment(4) . '/' . $this->uri->segment(5));
      } elseif (empty($this->uri->segment(5)) and !empty($this->uri->segment(4))) {
        redirect('admin_store/bundling/request_bundling/' . $this->uri->segment(4));
      } else {
        redirect('admin_store/bundling/request_bundling');
      }
    }
  }
  ...
  public function rb_edit($id_request_bundling)
  {
    ...
    if ($this->form_validation->run() == false) {
      ...
      $this->load->view('templates/admin_store_sidebar');
      $this->load->view('templates/navbar');
      $this->load->view('admin_store/bundling/request_bundling_edit');
      $this->load->view('templates/footer');
    } else {
